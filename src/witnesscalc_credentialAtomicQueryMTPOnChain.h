#ifndef WITNESSCALC_CREDENTIALATOMICQUERYMTPONCHAIN_H
#define WITNESSCALC_CREDENTIALATOMICQUERYMTPONCHAIN_H
...
#endif // WITNESSCALC_CREDENTIALATOMICQUERYMTPONCHAIN_H
