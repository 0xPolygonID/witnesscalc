#ifndef WITNESSCALC_CREDENTIALATOMICQUERYSIGONCHAIN_H
#define WITNESSCALC_CREDENTIALATOMICQUERYSIGONCHAIN_H
...
#endif // WITNESSCALC_CREDENTIALATOMICQUERYSIGONCHAIN_H
